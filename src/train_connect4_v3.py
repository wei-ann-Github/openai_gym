...
if __name__ == "__main__":
    ...
    def save_best_fn(policy):
        model_save_path_p1 = ROOT / os.path.join("log", "rps", "dqn", f"policy_p1_{version}.pth")
        model_save_path_p2 = ROOT / os.path.join("log", "rps", "dqn", f"policy_p2_{version}.pth")
        os.makedirs(ROOT /  os.path.join("log", "rps", "dqn"), exist_ok=True)
        torch.save(policy.policies[agents[0]].state_dict(), model_save_path_p1)
        torch.save(policy.policies[agents[1]].state_dict(), model_save_path_p2)
